...
/**
 * The type of the React {@code Component} state of {@link PrividInviteOthersDialogButton}.
 */
type State = {
 ...
 * @extends Component
 */
class PrividInviteOthersDialogButton extends Component<Props, State> {
    /**
    ...
    /**
     * Initializes new {@code PrividInviteOthersDialogButton} instance.
     *
     * @inheritdoc
     */
    constructor(props) {
...
/**
 * Maps (parts of) the Redux state to the associated {@code PrividInviteOthersDialogButton}
 * component's props.
 *
...
export default translate(connect(_mapStateToProps)(PrividInviteOthersDialogButton));
